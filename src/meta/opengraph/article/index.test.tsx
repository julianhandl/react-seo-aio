...
test('it should render all normal opengraph article meta-tags', () => {
    ...
    const typeTag = container.querySelector('meta[property="og:type"]');
    expect(typeTag).toBeDefined();
    expect(typeTag!.getAttribute("content")).toBe("article")
